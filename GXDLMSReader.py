...
#  Filename: $HeadURL$
#
#  Functions: initialize_get_value_by_obis_code, get_value_by_obis_code
#                   31/05/2024
#                   GrupoMedidoresInteligentes - Proyecto Aplicado en TIC 2
#
...
class GXDLMSReader:
    ...
    def __init__(self, client:GXDLMSClient, media, trace, invocationCounter):
    ...
    def read(self, item:GXDLMSObject, attributeIndex):
    ...
    def getReadOut(self):
        ...
        for it in self.client.objects:
            ...
            self.writeTrace("-------- Reading " + str(it.objectType) +"IT: "+ str(it) +" " + str(it.name) + " " + it.description, TraceLevel.INFO)
    ...
    # Inicialización IT para posterior lectura de los obiscode (logicalName)
    ...
    # Codigo para leer las variables de cada medidor por obiscode / registro en el excel
